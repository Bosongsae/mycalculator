...
let lastinputs = "";
let isconclusion = false; // result 입력 후인지 판단하는 변수 기본 : false, result 입력후 : true
let numbers = []; // 입력된 숫자를 담을 배열
let ops = []; // 입력된 연산자를 담을 배열
...
function calculator(numbers, ops) {
